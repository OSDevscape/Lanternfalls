(function () {
  ...
  function render() {
    ...
    page.innerHTML =
      ...
      '<section class="adventure-card adventure-coming"><span class="adventure-label">Coming Next</span><p>Reading-time tracking, XP, gold, streaks, quests, book bosses, and loot will be added step by step without disrupting your Library.</p></section>' +
      '</main>';
