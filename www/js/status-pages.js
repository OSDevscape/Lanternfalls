(function () {
  function install() {
    ...
    style.textContent =
      '.status-pages{display:flex;gap:9px;flex-wrap:wrap;margin:10px 0}.status-pages button{flex:1;min-width:130px;padding:11px;border:1px solid #A8823C;border-radius:3px;background:#1B2129;color:#F6F1E4;text-align:left;cursor:pointer}.status-page{position:fixed;inset:0;z-index:60;overflow:auto;background:#14181C;color:#F6F1E4}.status-page.hidden{display:none!important}.status-page-header{display:flex;align-items:center;gap:14px;padding:20px;border-bottom:1px solid rgba(168,130,60,.25)}.status-page-header button{border:0;background:none;color:#F6F1E4;font-size:32px;cursor:pointer}.status-page h2{margin:0;font:22px Georgia,serif}.status-page-list{padding:18px}.status-page-item{display:flex;align-items:center;gap:14px;padding:12px 0;border-bottom:1px solid rgba(246,241,228,.12);cursor:pointer}.status-page-item img{width:48px;height:72px;object-fit:cover;background:#1B2129;border-radius:2px}.status-page-item strong{display:block;font:700 17px Georgia,serif}.status-page-item span{display:block;margin-top:4px;color:#cdbdb4;font-size:13px}.status-page-empty{padding:36px 6px;color:#8A8378;text-align:center}';
