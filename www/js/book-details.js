(function () {
  function readBook(card) {
    ...
    book.title = title; book.author = author; book.status = book.status || ((card.querySelector('.card-stamp') || {}).textContent || 'To Read');
