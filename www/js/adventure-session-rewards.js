(function () {
  ...
  function show(items) {
    ...
    overlay.innerHTML = '<div class="session-reward-card"><span class="session-reward-kicker">' + kicker + '</span><h2>' + title + '</h2><p class="session-reward-summary">' + escape(summary) + '</p><div class="session-reward-totals">' + (xp ? '<b>+' + xp + ' XP</b>' : '') + '<b>+' + gold + ' gold</b></div>' + bossLoot + '<div class="session-reward-bonuses"></div><button type="button">Continue Adventure</button></div>';
