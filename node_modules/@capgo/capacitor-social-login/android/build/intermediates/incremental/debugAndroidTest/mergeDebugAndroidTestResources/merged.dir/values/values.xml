...
<resources xmlns:ns1="http://schemas.android.com/tools" xmlns:ns2="urn:oasis:names:tc:xliff:document:1.2">
    ...
    <string name="com_facebook_loginview_logged_in_as">Logged in as: <ns2:g id="user name">%1$s</ns2:g></string>
    ...
    <string name="com_facebook_smart_login_confirmation_continue_as">Continue as <ns2:g id="user name">%1$s</ns2:g></string>
